 ...
 */
    public class PagerSlidingTabStrip extends HorizontalScrollView
    {
        ...
        // @formatter:off
        private static final int[] ATTRS = new int[] { android.R.attr.textColorPrimary, android.R.attr.textSize, android.R.attr.textColor, android.R.attr.padding, android.R.attr.paddingLeft,
        ...
        public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle)
        {
            ...
            tabTextSize = a.getDimensionPixelSize(a.getIndex(1), tabTextSize);
            ColorStateList colorStateList = a.getColorStateList(a.getIndex(2));
            int textPrimaryColor = a.getColor(TEXT_COLOR_PRIMARY, Color.WHITE);

            underlineColor = textPrimaryColor;
            dividerColor = textPrimaryColor;
            indicatorColor = textPrimaryColor;
            int padding = a.getDimensionPixelSize(a.getIndex(3), 0);
            paddingLeft = padding > 0 ? padding : a.getDimensionPixelSize(a.getIndex(4), 0);
            paddingRight = padding > 0 ? padding : a.getDimensionPixelSize(a.getIndex(5), 0);
            a.recycle();
            ...
            tabTextColor = colorStateList == null ? getColorStateList(Color.argb(textAlpha, Color.red(textPrimaryColor), Color.green(textPrimaryColor), Color.blue(textPrimaryColor))) : colorStateList;
