package com.Provider.Common.Core.dbaccess.DataActions;

import android.content.ContentValues;
import android.database.Cursor;

import com.Provider.Common.Core.Globals.ProviderGlobals;
import com.Provider.Common.Core.commonuse.IsNullOrEmpty;
import com.Provider.Common.Core.Log.LogLevel;
import com.Provider.Common.Core.Log.Logger;
import com.Provider.Common.Core.dbaccess.DBController;
import com.Provider.Common.Core.dbaccess.DataDefinitions.RequestTracking;
